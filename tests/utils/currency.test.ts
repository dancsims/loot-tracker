...
import { getTotals, toGrandTotal, getTransactionsWithBalances, formatSigned } from '../../src/utils/currency'
...
const TRANSACTIONS: Transaction[] = [
  { id: 't1', date: '2026-01-01', description: 'Starting funds', amounts: { gp: 50 },         note: '' },
  { id: 't2', date: '2026-01-05', description: 'Sold loot',      amounts: { gp: 10, sp: 5 },  note: '' },
  { id: 't3', date: '2026-01-10', description: 'Paid for inn',   amounts: { gp: -8, sp: -2 }, note: '' },
]
...
describe('getTotals', () => {
  ...
  it('ignores currency ids not in the currencies list', () => {
    const txWithUnknown: Transaction[] = [
      { id: 'u1', date: '2026-01-01', description: 'Unknown', amounts: { xx: 999 }, note: '' },
    ]
...
describe('getTransactionsWithBalances', () => {
  it('returns transactions sorted by date', () => {
    const shuffled: Transaction[] = [TRANSACTIONS[2], TRANSACTIONS[0], TRANSACTIONS[1]]
